import glob
from Force_model_impact_on_electrode.Bertil_filereader import *
...
def local_data_gatherer(simulation_directory):
    ...
    return force_data, surface_index,surface_position_data, periodic_BC_data
...
#    simulation_directory = 'c:/Users/Axel/Documents/DEM/results/electrode_calendaring/SN0_1000particlesWithBinder_new_packingmethod_2'
    ...
    if (simulation_directory.startswith("/scratch")):force_data, surface_index, surface_position_data, periodic_BC_data = bertil_data_gatherer(simulation_directory)
    elif (simulation_directory.startswith("c:")):force_data, surface_index, surface_position_data, periodic_BC_data = local_data_gatherer(simulation_directory)
    else: print("Error with simulation directory")



    calendering_surface_force = force_data[:, surface_index[1]+1].astype(float)
    ...
    calendering_surface_position = surface_position_data[:,surface_index[1]+14].astype(float)
