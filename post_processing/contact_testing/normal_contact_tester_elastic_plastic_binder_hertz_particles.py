...
if __name__ == '__main__':
    ...
    simulation_directory =  "C:/Users/Axel/Documents/DEM/results/contact_testing/elastic_plastic_binder_hertz_particle/normal_contact/visco_relaxation_normal_contact/"
    ...
    ax_particle_forces.set_ylabel("F_x Force in particle [N]")
    ax_particle_forces.legend()


    figure_partcle_positions_time, ax_particle_positions_time = plt.subplots()
    lns_particle_1_pos_t = ax_particle_positions_time.plot(time, p1_data_mat[:,1],'r',linewidth=3,label=r'P_1')
    ax_particle_positions_time.set_xlabel('Time [s]')
    ax_particle_positions_time.set_ylabel('x position [m]')
