...
if __name__ == '__main__':
    ...
    lns_soc_0_std = ax_soc.errorbar(SOC_0.strain_points * 1E2, SOC_0.stiffness_mean * 1E-9,
                                    yerr=SOC_0.stiffness_std * 1E-9, elinewidth=2, capthick=None, capsize=12,
    ...
    lns_soc_50_std = ax_soc.errorbar(SOC_50.strain_points * 1E2, SOC_50.stiffness_mean * 1E-9,
                                     yerr=SOC_50.stiffness_std * 1E-9, elinewidth=2, capthick=None, capsize=12,
    ...
    lns_soc_100_std = ax_soc.errorbar(SOC_100.strain_points * 1E2, SOC_100.stiffness_mean * 1E-9,
                                      yerr=SOC_100.stiffness_std * 1E-9, elinewidth=2, capthick=None, capsize=12,
    ...
    lns_swelling_std = ax_split.errorbar(swelling.strain_points * 1E2, swelling.stiffness_mean * 1E-9,
                                         yerr=swelling.stiffness_std * 1E-9, elinewidth=2, capthick=None, capsize=12,
    ...
    lns_mat_deg_std = ax_split.errorbar(material_deg.strain_points * 1E2, material_deg.stiffness_mean * 1E-9,
                                        yerr=material_deg.stiffness_std * 1E-9, elinewidth=2, capthick=None, capsize=12,
                                        lw=0, marker='', markersize=0, markeredgewidth=2, color='C2',
                                        label='Standard deviation')
    ...
    lns_cycle_1_std = ax_cycling.errorbar(cycle_1.strain_points * 1E2, cycle_1.stiffness_mean * 1E-9,
                                          yerr=cycle_1.stiffness_std * 1E-9, elinewidth=2, capthick=None, capsize=12,
                                          lw=0, marker='', markersize=0, markeredgewidth=2, color='C4',
                                          label='Standard deviation')
    ...
    lns_cycle_3_std = ax_cycling.errorbar(cycle_3.strain_points * 1E2, cycle_3.stiffness_mean * 1E-9,
                                          yerr=cycle_3.stiffness_std * 1E-9, elinewidth=2, capthick=None, capsize=12,
                                          lw=0, marker='', markersize=0, markeredgewidth=2, color='C5',
                                          label='Standard deviation')
    ...
    lns_cycle_10_std = ax_cycling.errorbar(cycle_10.strain_points * 1E2, cycle_10.stiffness_mean * 1E-9,
                                           yerr=cycle_10.stiffness_std * 1E-9, elinewidth=2, capthick=None, capsize=12,
                                           lw=0, marker='', markersize=0, markeredgewidth=2, color='C6',
                                           label='Standard deviation')
