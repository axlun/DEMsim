...
#include "fracturable_swelling_spherical_particle.h"


template< typename ForceModel>
DEM::FracturableSwellingSphericalParticle<ForceModel>::FracturableSwellingSphericalParticle(
...
template <typename ForceModel>
void DEM::FracturableSwellingSphericalParticle<ForceModel>::swell(const double new_swelling_this_inc)
{
...
template <typename ForceModel>
void DEM::FracturableSwellingSphericalParticle<ForceModel>::scale_material(const double new_material_scaling_this_inc)
{
...
template <typename ForceModel>
std::string DEM::FracturableSwellingSphericalParticle<ForceModel>::get_output_string() const
{
...
template <typename ForceModel>
std::string DEM::FracturableSwellingSphericalParticle<ForceModel>::restart_data() const
{
