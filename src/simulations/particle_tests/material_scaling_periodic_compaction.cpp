//
// Created by Axel on 2024-10-16
// based on swelling_periodic_compaction.cpp
//
...
void DEM::material_scaling_periodic_compaction(const std::string& settings_file_name) {
    using namespace DEM;
...
//            auto unloading_simulator_2 = Engine<ForceModel, ParticleType>(restart_2_filename.str());
//            std::stringstream restart_3_filename;
//            restart_3_filename << output_directory << "restart_3.res";
//            unloading_simulator_2.write_restart_file(restart_3_filename.str());
//        simulator.make_output();
...
//            unload_top_surface->set_velocity(Vec3(0, 0, 0));// -surface_velocity));
            for (auto& p:unloading_simulator.get_particles())
            {
