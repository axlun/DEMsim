...
std::map<std::string, DEM::SimulationFunctionPtr> DEM::valid_simulations() {
    ...
    return std::map<std::string, SimulationFunctionPtr > {
            ...
            {"fracturing_particle_periodic_compaction",              DEM::fracturing_particle_periodic_compaction},
            {"swelling_particle_tester",                                            DEM::swelling_particle_tester},
            {"swelling_particle_wall_tester",                                  DEM::swelling_particle_wall_tester},
            {"material_scaling_cube_die_compaction",                    DEM::material_scaling_cube_die_compaction},
            {"material_scaling_periodic_compaction",                    DEM::material_scaling_periodic_compaction},
