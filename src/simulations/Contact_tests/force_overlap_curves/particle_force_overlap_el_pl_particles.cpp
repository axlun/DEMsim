...
void DEM::particle_force_overlap_el_pl_particles(const std::string &settings_file_name)
{
    using namespace DEM;
...
// =PARTICLE CONTACT ===================================================================================================
    ...
    auto p1 = simulator.create_particle(radius_1,Vec3{-radius_1*1.00010,0 , 0},
                                        Vec3{0,0,0}, mat);
    auto p2 = simulator.create_particle(radius_2,Vec3{radius_2*1.00010,0 , 0},
                                        Vec3{0,0,0}, mat);
