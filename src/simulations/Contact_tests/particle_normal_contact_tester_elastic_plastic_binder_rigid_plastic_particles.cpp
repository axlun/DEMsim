...
void DEM::particle_normal_contact_tester_elastic_plastic_binder_rigid_plastic_particles(const std::string &settings_file_name)
{
    using namespace DEM;
...
//
//    auto p1 = simulator.create_particle(radius,Vec3{-radius*1.0010,0 , 0},Vec3{0,0,0}, mat);
//    auto p2 = simulator.create_particle(radius,Vec3{radius*1.0010,0 , 0},Vec3{0,0,0}, mat);
//    simulator.set_mass_scale_factor(mass_scaling);
//
//    simulator.setup(radius*1);
//
///*
...
//    auto particle_normal_displacement =  radius*0.01; //Move particles 1% of the radius
