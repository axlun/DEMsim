...
//    }
    ...
    auto filling_output = simulator.create_output(output_directory , 1E-3ms);
...
// New packing method
    ...
    EngineType::RunForTime run_for_time(simulator, .1E-1ms);//Gives particles velocity of .1m/s
    simulator.run(run_for_time);

    simulator.set_gravity(Vec3(0, 0, -1E-1)); //Use gravity for initial packing of particles
    EngineType::RunForTime run_for_time_2(simulator, 3E-1ms);
