...
// New packing method
    ...
    EngineType::RunForTime run_for_time(simulator, .1E1s);//Gives particles velocity of .1m/s
    simulator.run(run_for_time);

    simulator.set_gravity(Vec3(0, 0, -1E-1)); //Use gravity for initial packing of particles
    EngineType::RunForTime run_for_time_2(simulator, 3E1s);
