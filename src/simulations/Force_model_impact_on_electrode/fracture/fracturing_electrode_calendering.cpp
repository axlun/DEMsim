//
// Adapted from restart_electrode_calendering_el_pl_binder_el_pl_particle.cpp on 2024-06-25
//
...
void DEM::fracturing_electrode_calendering(const std::string &settings_file_name)
{
    using namespace DEM;
...
//======================================================================================================================
    ...
    std::cout<<"Height of uppermost particle: "<< h_3<< std::endl;
    std::cout<<"Calendering height : "<< calendering_height << std::endl;
    if (h_3<1.2*calendering_height)
    {
        std::cout<<"Height of uppermost particle lower then 1.2 h_al: "<< h_3 << std::endl;
        h_3=1.2*calendering_height;
        std::cout<<"Calendering surface changed to: "<< h_3 << std::endl;
...
//============================Calculate output frequency================================================================
    ...
    restart_output->print_fractured_particles = true;
