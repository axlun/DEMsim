//
// Adapted from electrode_mechanical_loading_el_pl_binder_el_pl_particle.cpp on 2024-06-27
//
...
void DEM::swelling_electrode_mechanical_loading(const std::string &settings_file_name)
{
    using namespace DEM;
