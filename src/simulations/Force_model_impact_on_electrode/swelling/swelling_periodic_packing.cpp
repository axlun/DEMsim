//
// Adapted from electrode_natural_periodic_packing_el_pl_binder_el_pl_particle.cpp on 2024-06-25
//
...
void DEM::swelling_periodic_packing(const std::string& settings_file_name) {
    using namespace DEM;
