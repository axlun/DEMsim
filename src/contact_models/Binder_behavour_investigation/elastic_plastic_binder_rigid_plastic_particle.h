...
namespace DEM{
    ...
    class ParameterMap;
    class elastic_plastic_binder_rigid_plastic_particle{
        using ParticleType = SphericalParticle<elastic_plastic_binder_rigid_plastic_particle>;
        using SurfaceType = Surface<elastic_plastic_binder_rigid_plastic_particle, ParticleType>;

    public:
        elastic_plastic_binder_rigid_plastic_particle(ParticleType* particle1, ParticleType* particle2, std::chrono::duration<double>dt);
        elastic_plastic_binder_rigid_plastic_particle(ParticleType* particle1, SurfaceType* surface, std::chrono::duration<double>dt );

        elastic_plastic_binder_rigid_plastic_particle(ParticleType*, ParticleType*, std::chrono::duration<double>, const ParameterMap& parameters);
        elastic_plastic_binder_rigid_plastic_particle(ParticleType*, SurfaceType*, std::chrono::duration<double>, const ParameterMap& parameters);
