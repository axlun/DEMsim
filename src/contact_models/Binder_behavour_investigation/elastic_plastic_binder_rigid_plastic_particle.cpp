...
#include "elastic_plastic_binder_rigid_plastic_particle.h"
...
DEM::elastic_plastic_binder_rigid_plastic_particle::elastic_plastic_binder_rigid_plastic_particle(DEM::elastic_plastic_binder_rigid_plastic_particle::ParticleType* particle1,
                                                                                                                  DEM::elastic_plastic_binder_rigid_plastic_particle::ParticleType* particle2,
...
DEM::elastic_plastic_binder_rigid_plastic_particle::elastic_plastic_binder_rigid_plastic_particle(
        DEM::elastic_plastic_binder_rigid_plastic_particle::ParticleType* particle1,
        DEM::elastic_plastic_binder_rigid_plastic_particle::SurfaceType* surface, std::chrono::duration<double> dt)
{
        auto mat1 = dynamic_cast<const ElectrodeMaterial *>(particle1->get_material());
        material = mat1;
...
DEM::elastic_plastic_binder_rigid_plastic_particle::elastic_plastic_binder_rigid_plastic_particle(
        DEM::elastic_plastic_binder_rigid_plastic_particle::ParticleType* particle1,
        DEM::elastic_plastic_binder_rigid_plastic_particle::SurfaceType * surface1,
        std::chrono::duration<double>, const DEM::ParameterMap& parameters):
        psi0_(parameters.get_parameter<double>("psi0_")),
        psi0T_B_(parameters.get_parameter<double>("psi0T_B_")),
        kTp_(parameters.get_parameter<double>("kTp_")),
...
void DEM::elastic_plastic_binder_rigid_plastic_particle::update(double h, const DEM::Vec3& dt, const Vec3& drot, const DEM::Vec3& normal)
{
...
unsigned DEM::elastic_plastic_binder_rigid_plastic_particle::M;
const DEM::ElectrodeMaterial* DEM::elastic_plastic_binder_rigid_plastic_particle::material;

double  DEM::elastic_plastic_binder_rigid_plastic_particle::update_normal_force(double h)
{
    double dh = h-h_;
    h_ = h;
    if (h > hmax_)
...
void  DEM::elastic_plastic_binder_rigid_plastic_particle::update_tangential_force(const DEM::Vec3& dt, const DEM::Vec3& normal)
{
    if (adhesive() && bonded_)
    {
...
std::string DEM::elastic_plastic_binder_rigid_plastic_particle::restart_data() const {
...
bool DEM::elastic_plastic_binder_rigid_plastic_particle::create_binder_contact(const ElectrodeMaterial* mat)
{
...
DEM::Vec3 DEM::elastic_plastic_binder_rigid_plastic_particle::get_rolling_resistance_torque() const {
    //if (binder_contact_) {
...
std::string DEM::elastic_plastic_binder_rigid_plastic_particle::get_output_string() const {
    std::stringstream ss;
...
void DEM::elastic_plastic_binder_rigid_plastic_particle::set_increment(std::chrono::duration<double> dt) {
    dt_ = dt.count();
    Ai = {};
    Bi = {};
    for (unsigned i=0; i!=M; ++i) {
...
bool DEM::elastic_plastic_binder_rigid_plastic_particle::adhesive() const
{
